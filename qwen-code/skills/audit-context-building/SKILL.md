...
Before deep analysis, the model performs a minimal mapping:
...
When performing ultra-granular analysis, The model MUST structure output following the format defined in [OUTPUT_REQUIREMENTS.md](resources/OUTPUT_REQUIREMENTS.md).
...
The model may spawn subagents for:
...
While active, The model should NOT:
